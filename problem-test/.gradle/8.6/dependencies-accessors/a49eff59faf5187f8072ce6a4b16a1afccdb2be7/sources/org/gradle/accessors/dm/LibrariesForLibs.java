...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class CommonsProjectBundleAccessors extends BundleFactory {
        private final CommonsProjectCarenationBundleAccessors baccForCommonsProjectCarenationBundleAccessors = new CommonsProjectCarenationBundleAccessors(objects, providers, config, attributesFactory, capabilityNotationParser);
        ...
        /**
         * Group of bundles at <b>bundles.commons.project.carenation</b>
         */
        public CommonsProjectCarenationBundleAccessors getCarenation() {
            return baccForCommonsProjectCarenationBundleAccessors;
        }

    }

    public static class CommonsProjectCarenationBundleAccessors extends BundleFactory {
        private final CommonsProjectCarenationDataBundleAccessors baccForCommonsProjectCarenationDataBundleAccessors = new CommonsProjectCarenationDataBundleAccessors(objects, providers, config, attributesFactory, capabilityNotationParser);

        public CommonsProjectCarenationBundleAccessors(ObjectFactory objects, ProviderFactory providers, DefaultVersionCatalog config, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) { super(objects, providers, config, attributesFactory, capabilityNotationParser); }

        /**
         * Group of bundles at <b>bundles.commons.project.carenation.data</b>
         */
        public CommonsProjectCarenationDataBundleAccessors getData() {
            return baccForCommonsProjectCarenationDataBundleAccessors;
        }

    }

    public static class CommonsProjectCarenationDataBundleAccessors extends BundleFactory {
        private final CommonsProjectCarenationDataEntityBundleAccessors baccForCommonsProjectCarenationDataEntityBundleAccessors = new CommonsProjectCarenationDataEntityBundleAccessors(objects, providers, config, attributesFactory, capabilityNotationParser);

        public CommonsProjectCarenationDataBundleAccessors(ObjectFactory objects, ProviderFactory providers, DefaultVersionCatalog config, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) { super(objects, providers, config, attributesFactory, capabilityNotationParser); }

        /**
         * Group of bundles at <b>bundles.commons.project.carenation.data.entity</b>
         */
        public CommonsProjectCarenationDataEntityBundleAccessors getEntity() {
            return baccForCommonsProjectCarenationDataEntityBundleAccessors;
        }

    }

    public static class CommonsProjectCarenationDataEntityBundleAccessors extends BundleFactory  implements BundleNotationSupplier{

        public CommonsProjectCarenationDataEntityBundleAccessors(ObjectFactory objects, ProviderFactory providers, DefaultVersionCatalog config, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) { super(objects, providers, config, attributesFactory, capabilityNotationParser); }

        /**
         * Dependency bundle provider for <b>commons.project.carenation.data.entity</b> which contains the following dependencies:
         * <ul>
         ...
         */
        public Provider<ExternalModuleDependencyBundle> asProvider() {
            return createBundle("commons.project.carenation.data.entity");
        }

        /**
         * Dependency bundle provider for <b>commons.project.carenation.data.entity.kapt</b> which contains the following dependencies:
         * <ul>
        ...
        public Provider<ExternalModuleDependencyBundle> getKapt() {
            return createBundle("commons.project.carenation.data.entity.kapt");
        }

        /**
         * Dependency bundle provider for <b>commons.project.carenation.data.entity.test</b> which contains no dependencies
         * <p>
         * This bundle was declared in catalog libs.versions.toml
         */
        public Provider<ExternalModuleDependencyBundle> getTest() {
            return createBundle("commons.project.carenation.data.entity.test");
        }
