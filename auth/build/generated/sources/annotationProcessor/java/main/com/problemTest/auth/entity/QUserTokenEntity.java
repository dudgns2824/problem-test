...
public class QUserTokenEntity extends EntityPathBase<UserTokenEntity> {
    ...
    private static final long serialVersionUID = 2065265986L;
    ...
    public final com.problemTest.auth.entity.id.QUserTokenId id;
    ...
    public QUserTokenEntity(Class<? extends UserTokenEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.id = inits.isInitialized("id") ? new com.problemTest.auth.entity.id.QUserTokenId(forProperty("id")) : null;
    }
